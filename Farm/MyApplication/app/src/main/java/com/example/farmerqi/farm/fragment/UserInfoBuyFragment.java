...
public class UserInfoBuyFragment extends Fragment {

    private RecyclerView recyclerView;
    private TextView textView;
    private getBuyProducts getBuyProducts;
    ...
    public void onAttach(Context context) {
        ...
        getBuyProducts = (getBuyProducts)context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_user_info_buy,container,false);
        recyclerView = (RecyclerView)view.findViewById(R.id.user_info_buy_recyclerView);
        ...
        textView = (TextView)view.findViewById(R.id.user_info_buy_text);
        return view;
    }

    public interface getBuyProducts{
        int getBuyProducts();
    }
